...
class CNN_BLSTM(object):
    ...
    def loadData(self,trainSentences,testSentences,devSentences):
        """Load data and add character information"""
        self.trainSentences = trainSentences #readfile("data/train.txt")
        self.devSentences = devSentences #readfile("data/dev.txt")
        self.testSentences = testSentences #readfile("data/test.txt")
    ...
    def embed(self):
        ...
        for c in " 0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"+thai_characters+".,-_()[]{}!?:;#'\"/\\%$`&=*+@^~|<>":
